...
\newcommand{\names}{The Duck -- Anony Mouse}
\newcommand{\playernumber}{1234567/9876543}

% General approach:
\newcommand{\generalapproach}{Sub-Standard American}
\newcommand{\minHCPopen}{12}
\newcommand{\minHCPresp}{6}
...
\newcommand{\cldescribe}{Clubs or Balanced} % blank space under 1C
\newcommand{\clresponses}{} % Resp: line under 1C
\setboolean{ctxfr}{true} % transfer responses to 1C

\newcommand{\clrespdi}{\bluereg{Hearts}} % text after "1D response"
...
\newcommand{\didescribe}{5 unless 4=4=4=1} % blank space under 1D. e.g ''4 unless 4-4-3-2''
\newcommand{\diresponses}{1\,\rd-1\,M; 1NT, 2NT CONV}
...
\newcommand{\majothertextbottom}{Drury: 2\,\bc\ 3-card LR, 2\,\rd\ 4-card 8--11} % Other major methods line two

\setboolean{ra2nt}{true} % Jacoby
\setboolean{ra3nt}{true} % 1M-3NT
\setboolean{raspl}{true} % Splinter
\newcommand{\majraisetext}{1\,M--3NT 5 card, weak, A/K outside } % Text line for Bergen, fitjumps, etc
...
\newcommand{\nthightext}{17}
\newcommand{\ntseatvul}{not fav or 4\textsuperscript{th}}
\newcommand{\altntlowtext}{10} % If variable NT, second range here
\newcommand{\altnthightext}{13}
...
\newcommand{\altntresponse}{EHAA STY}
...
\newcommand{\ntditext}{Nat/wk} % Other meaning for 1NT-2\d
%\setboolean{nat2h}{true}
\setboolean{jac2h}{true}
\newcommand{\nthetext}{Nat/wk} % Other meaning for 1NT-2\h
%\setboolean{nat2s}{true}
\setboolean{trf2s}{true}
\newcommand{\ntsptext}{Nat/wk} % Other meaning for 1NT-2\s
\setboolean{nat2n}{true}
%\setboolean{trf2n}{true}
\newcommand{\ntnttext}{} % Other meaning for 1NT-2NT

% 1NT: Second column
\newcommand{\ntcjumptext}{\redreg{GF Puppet}} % 1NT-3C
\newcommand{\ntdjumptext}{\redreg{5=5 minors GF}}
\newcommand{\nthjumptext}{\redreg{3=1--(54)}}
\newcommand{\ntsjumptext}{\redreg{1=3--(54)}} % 1NT-3S
\newcommand{\ntothertexttop}{wk: 3 bids NAT INV} % Other conventions over 1NT
...
\newcommand{\twonsptext}{\redreg{\textrightarrow 3NT, to play or minor(s) ST}} % 2NT-3S
...
\newcommand{\threenonesuittext}{solid minor, 0 outside} % One suit description 3NT box

% 2 Clubs
\newcommand{\twoclowtext}{Big} % 2C point range
\newcommand{\twochightext}{}
\newcommand{\twocldescribe}{could be 8.5 PT w/Defence}
...
\newcommand{\twoddescribe}{Disciplined 1\textsuperscript{st} and 2\textsuperscript{nd}}
...
% Bottom of card
\newcommand{\jshifttext}{Soloway in non-comp, Fit J/S in comp and by PH} % jump shift responses
\newcommand{\vsstrongart}{CRaSh} % vs str/VS openings
...
\newcommand{\footnotestop}{DYWAD over disasters} % 2 lines for additional conventions at bottom
\newcommand{\footnotesbottom}{\redreg{CRaSh after strong 1\,\bc--1\,\rd}}
...
\newcommand{\doubleothertext}{Snapdragon, DSIX at 3-level} % Other special doubles
...
% Defense vs. NT
\newcommand{\firstcondition}{Strong Direct} % ''vs.'' line, first half
\newcommand{\firstvsdbl}{Penalty}   % 1NT-X
\newcommand{\firstvstwocl}{\bluereg{Diamonds}} % 1NT-2C
\newcommand{\firstvstwodi}{\bluereg{Hearts}} % 1NT-2D
\newcommand{\firstvstwohe}{\bluereg{Spades}} % 1NT-2H
\newcommand{\firstvstwosp}{\bluereg{Clubs}} % 1NT-2S
\newcommand{\firstvstwont}{\redreg{Minors}} % 1NT-2NT
\newcommand{\secondcondition}{Weak or Bal} % the same six lines, right half
\newcommand{\secondvsdbl}{Penalty}
\newcommand{\secondvstwocl}{\bc}
\newcommand{\secondvstwodi}{\rd}
\newcommand{\secondvstwohe}{\rh}
\newcommand{\secondvstwosp}{\bs}
\newcommand{\secondvstwont}{\redreg{Minors}}
...
\newcommand{\toxtrftext}{1 level} % transfers through?
...
% Opening preempts
\newcommand{\threelevelstyletop}{Sound 1/2 seat}
\newcommand{\threelevelstylebottom}{Anything in 3rd}
\newcommand{\threelevelresp}{}
\newcommand{\fourlevelstyle}{Sound 1/2 seat}
...
\newcommand{\oplebtext}{\bluereg{Transfer rsps}} % leb text
\newcommand{\opcuebid}{stopper ask}
\newcommand{\opjumpoc}{Leaping Michaels}
...
\newcommand{\controlcuetext}{Italian Style}
\newcommand{\slaminterftext}{DOPI/DEPO}
...
\newcommand{\trumpsignaltext}{hi--lo wants ruff}
...
\newcommand{\prattrank}{1}
\newcommand{\prcourank}{2}
\newcommand{\prsuirank}{3}
